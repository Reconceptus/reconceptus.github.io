        ...
        !(function(e, t) {
                ...
                function Ce(p, h, g, v, m, e) {
                    return (
                        ...
                        le(function(e, t, n, r) {
                            ...
                            } else (d = Te(d === t ? d.splice(l, d.length) : d)), m ? m(null, t, d, r) : H.apply(t, d);
                        })
                    );
                }
                function Ee(e) {
            ...
            var _ = function(e, t, n, r, o, i, a) {
                    var s = 0,
                        u = e.length,
                        l = null == n;
                    if ('object' === w(n)) for (s in ((o = !0), n)) _(e, t, s, n[s], !0, i, a);
                    else if (
                        void 0 !== r &&
                        ((o = !0),
                        b(r) || (a = !0),
                ...
                special: {
                    ...
                    click: {
                        setup: function(e) {
                            var t = this || e;
                            return (
                                fe.test(t.type) && t.click && A(t, 'input') && Ne(t, 'click', Ee),
                                !1
                            );
                        },
                        trigger: function(e) {
                            var t = this || e;
                            return (
                                fe.test(t.type) && t.click && A(t, 'input') && Ne(t, 'click'), !0
                            );
                        },
                        _default: function(e) {
                            var t = e.target;
            ...
            function Re(n, r, o, i) {
                ...
                if (
                    ...
                    for (s = (a = k.map(ge(e, 'script'), Pe)).length; c < f; c++)
                        (u = e),
                            c !== d && ((u = k.clone(u, !0, !0)), s && k.merge(a, ge(u, 'script'))),
                            o.call(n[c], u, c);
                    if (s)
                        for (l = a[a.length - 1].ownerDocument, k.map(a, He), c = 0; c < s; c++)
                            (u = a[c]),
                                pe.test(u.type || '') &&
            ...
            (k.Animation = k.extend(wt, {
                ...
                tweener: function(e, t) {
                    for (
                        var n, r = 0, o = (e = b(e) ? ((t = e), ['*']) : e.match(H)).length;
                        r < o;
                        r++
                    )
                        (n = e[r]),
                ...
                k.fn.extend({
                    ...
                    hasClass: function(e) {
                        var t,
                            ...
                            r = 0;
                        for (t = ' ' + e + ' '; (n = this[r++]); )
                            if (1 === n.nodeType && -1 < (' ' + St(At(n)) + ' ').indexOf(t))
                                return !0;
                        return !1;
                    },
                });
