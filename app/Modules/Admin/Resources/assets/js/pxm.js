$(function ($) {
    $.pxml = {
            ...
            this.AjaxUploadFunc = new AjaxUpload(this.btnUpload, {
                ...
                onComplete: function (file, response) {
                    ...
                    if (r['result'] == "ok") {
                        ...
                        setTimeout(function () {$.pxml.addParentInput();}, 50)
                    } else {
        ...
        addParentInput: function (first, number) {
            var res, column, document, del = '', id;
        ...
        setImport: function () {
            ...
            console.log('document', $.pxml.document)
        ...
        setSchema: function (f) {
            if(f.column) {
                for(var ii = 0; (_.get(f, 'parent.parent_key ') || {}).length > ii; ii++) {
                    if(ii > 0) { $.pxml.addParentInput(true, ii) }
