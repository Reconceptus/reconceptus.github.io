module.exports = {
    prod: {
        common: 'prod/' /* path to ready files */,
        html: 'prod/' /* path to ready htmls */,
        js: 'prod/assets/js/' /* path to ready js */,
        css: 'prod/assets/css/' /* path to ready css */,
        img: 'prod/assets/images/' /* path to ready images */,
        media: 'prod/assets/media/' /* path to ready media-files */,
        svg: 'prod/assets/svg/' /* path to ready svg */,
        fonts: 'prod/assets/fonts/' /* path to ready fonts */,
    },
    dev: {
        common: 'dev/' /* path to ready files */,
    ...
    src: {
        ...
        html_layout: 'src/_code/layout/' /* path to source html layout-files */,
