!(function(i) {
    ...
    function(t, e, i) {
        'use strict';
        i(6), i(7), i(9), (window.fn = { win: i(10), introCarousel: i(11) });
        var n = [
            { selector: 'main', name: 'win' },
                    ...
                    return (
                        ...
                        (n.m = i = [
                            function(t, e, i) {
                                ...
                                function f() {
                                    o.landscape()
                                        ? (p('portrait'), u('landscape'), v('landscape'))
                                        : (p('landscape'), u('portrait'), v('portrait')),
                                        y();
                                }
                                function v(t) {
                ...
                function n() {
                    ...
                    0 == --s &&
                        ...
                        (m = window.MutationObserver
                            ? ((t = new MutationObserver(g)).observe(document.documentElement, {
                                  childList: !0,
                                  subtree: !0,
                                  attributes: !0,
                              }),
                        ...
                        ? (l[h].hasAttribute('href') &&
                          ...
                          d.length &&
                              ...
                              void 0 === i &&
                                  ...
                                  (s += 1))))
                        : p
                        ? d.length && v[d] && setTimeout(t({ useEl: l[h], base: d, hash: u }), 0)
                        : void 0 === v[d]
                        ? (v[d] = !0)
                        : v[d].onload && (v[d].abort(), delete v[d].onload, (v[d] = !0));
                }
                function f(t) {
                    var e;
                    return (
    ...
    function(t, e, i) {
        'use strict';
        var n = {
            data: { el: { window: 'window' }, val: { height: null, width: null, scrollTop: null } },
            init: function() {
                (this.data.val.width = window.innerWidth), this.setToGlobal(this.data.val.width);
            },
            setToGlobal: function(t, e, i) {
                window.winWidth = t;
            },
        };
        t.exports = n;
    ...
    function(t, e, i) {
        var n, s, o;
        window,
            (s = [i(1), i(17), i(19), i(20), i(21), i(22), i(23)]),
            void 0 ===
                (o =
                    'function' ==
                    typeof (n = function(t) {
