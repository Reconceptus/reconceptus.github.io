module.exports = {
    build: {
        html: 'build/' /* path to ready htmls */,
        js: 'build/assets/js/' /* path to ready js */,
        css: 'build/assets/css/' /* path to ready css */,
        img: 'build/assets/images/' /* path to ready images */,
        media: 'build/assets/media/' /* path to ready media-files */,
        svg: 'build/assets/svg/' /* path to ready svg */,
        fonts: 'build/assets/fonts/' /* path to ready fonts */,
    },
    src: {
    ...
    browser: 'build/' /* path for browsersync directory */,
