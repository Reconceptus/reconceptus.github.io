                    ...
                    (o.m = t = [
                        function(e, n, t) {
                            ...
                            function f(e) {
                                var n = null;
                                s(e) ||
                                    ((n = l.className.replace(/^\s+|\s+$/g, '')),
                                    (l.className = n + ' ' + e));
                            }
                            function p(e) {
                                s(e) && (l.className = l.className.replace(' ' + e, ''));
                            }
                            function w() {
                                i.landscape()
                ...
                var n,
                    ...
                    t = function() {
                        ...
                        for (i = 0; i < l.length; i += 1) {
                            try {
                                var d = l[i].getBoundingClientRect();
                            } catch (o) {
                                d = !1;
                            }
                            var c =
                            ...
                            c = c[1];
                            var s =
                                d && 0 === d.left && 0 === d.right && 0 === d.top && 0 === d.bottom;
                            d && 0 === d.width && 0 === d.height && !s
                                ? (l[i].hasAttribute('href') &&
                                  ...
                                  u.length &&
                                      (!0 !== (r = f[u]) &&
                                          setTimeout(e({ useEl: l[i], base: u, hash: c }), 0),
                                      void 0 === r &&
                                          void 0 !== (c = b(u)) &&
                                          ((r = new c()),
                                          ((f[u] = r).onload = n(r)),
            ...
            r = {
                init: function() {
                    var e = this,
                        ...
                        o = void 0;
                    try {
                        for (var r, i = l[Symbol.iterator](); !(n = (r = i.next()).done); n = !0)
