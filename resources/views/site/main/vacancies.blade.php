	...
	<section class="simple-page--bg">
		...
		<div class="content">
			<header class="light-style">
				<h1 class="headline_main">Vacancies</h1>
			</header>
		</div>
	</section>
	<div class="vacancy">
		<div class="content">
			...
			<div class="vacancy-quotes">
				<figure style="background-image: url('/images/items/10911829_78_z.jpg')"></a></figure>
				<div class="text">
					...
					<div class="contacts">
						<ul>
							...
							<li>
								<i class="ico-fly"><svg> <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/svg/sprite.svg#ico_contact-fly"></use> </svg></i>
